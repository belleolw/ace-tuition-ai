...
export default function TeacherTopicAnalyticsPage() {
  ...
  const reteachingPlan = [
    {
      day: "Monday",
      title: "Algebra Reteaching",
      meta: "Whole-class review of core errors",
      accent: "from-blue-500 to-cyan-400",
    },
    {
      day: "Wednesday",
      title: "Statistics Reinforcement",
  ...
  const topicSignals = [
    "Algebra dropped 5% from last quiz",
    "Statistics remains consistently weak",
    "Probability remains strongest across class",
  ]
      ...
      <div className="space-y-6">
          <section className="grid gap-5 lg:grid-cols-3">
            ...
            <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <div className="flex items-center justify-between gap-4">
                <div>
                  ...
                  <div className="mt-4 text-2xl font-semibold tracking-tight">61%</div>
                ...
                <div className="relative h-24 w-24">
                  <div
                    ...
                    style={{
                      background: `conic-gradient(#8b5cf6 0 61%, #e2e8f0 61% 100%)`,
                    }}
                  />
            ...
            <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="mt-4 text-3xl font-semibold tracking-tight">2 Topics</div>
              <div className="mt-5 h-3 overflow-hidden rounded-full bg-slate-100">
                <div className="h-full w-[33%] rounded-full bg-gradient-to-r from-teal-500 to-cyan-400" />
              </div>
            ...
            <div className="space-y-6">
              <div className="rounded-3xl border border-rose-100 bg-gradient-to-br from-rose-50 to-orange-50 p-6 shadow-sm">
                ...
                <p className="mt-4 text-sm leading-6 text-slate-600">
                  Algebra currently has the lowest class mastery and appears to be affecting
                  performance across multiple question types.
                </p>
                <div className="mt-4 rounded-2xl border border-white/80 bg-white/70 p-4">
                  <p className="text-sm text-slate-600">
                    Topics with low mastery across many students usually need whole-class reteaching
              ...
              <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
                ...
                <div className="mt-4 space-y-4">
                  <div className="rounded-2xl bg-slate-50 p-4">
                    ...
                    <div className="mt-1 font-semibold">Probability</div>
                  </div>
                  <div className="rounded-2xl bg-slate-50 p-4">
                    <div className="text-sm font-medium text-slate-500">Priority focus</div>
                    <div className="mt-1 font-semibold">Algebra reteaching</div>
                  </div>
                </div>
              </div>
