      ...
      <div className="space-y-6">
          <section className="grid gap-5 lg:grid-cols-3">
            ...
            <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <p className="mt-3 text-sm font-medium text-teal-600">Based on last 3 assessments</p>
            </div>
          </section>
            ...
            <div className="space-y-6">
              <div className="rounded-3xl border border-rose-100 bg-gradient-to-br from-rose-50 to-orange-50 p-6 shadow-sm">
                ...
                <p className="mt-4 text-sm leading-6 text-slate-600">
                  Your child’s Algebra performance has improved the most across recent practice and
                  assessments.
                </p>
                <div className="mt-4 rounded-2xl border border-white/80 bg-white/70 p-4">
                  <p className="text-sm text-slate-600">
                    Students who improve Algebra steadily often raise their overall predicted score
                    faster.
                  </p>
                </div>
              </div>
