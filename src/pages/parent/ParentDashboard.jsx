...
export default function ParentDashboard() {
  ...
  const studyPlan = [
    {
      day: "Monday",
      title: "Review Algebra practice set",
      meta: "Estimated time: 15 minutes",
      accent: "from-blue-500 to-cyan-400",
    },
    {
      day: "Wednesday",
      title: "Geometry concept review",
            ...
            <div className="space-y-6">
              <div className="rounded-3xl border border-rose-100 bg-gradient-to-br from-rose-50 to-orange-50 p-6 shadow-sm">
                ...
                <p className="mt-4 text-sm leading-6 text-slate-600">
                  Your child may benefit from additional algebra practice this week.
                </p>
              ...
              <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
                ...
                <div className="mt-4 space-y-4">
                  <div className="rounded-2xl bg-slate-50 p-4">
                    ...
                    <div className="mt-1 font-semibold">Encourage algebra practice today</div>
                  </div>
                  <div className="rounded-2xl bg-slate-50 p-4">
